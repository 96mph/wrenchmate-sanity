          ...
          <Card>
            ...
            <CardContent>
              <div className="grid md:grid-cols-2 gap-3">
                ...
                <Button className="flex items-center justify-center gap-2 h-24"><Plus className="w-4 h-4"/>Add Vehicle</Button>              </div>
            </CardContent>
          </Card>
        )}
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-sm text-gray-500">Cache guides and your last 10 items.</div>                </div>
                <input type="checkbox" />
              </div>
              <div className="flex items-center justify-between">
                <div>
